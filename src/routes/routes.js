...
import PlanDetailRoutes from '@/webapp/views/plan/routes';
...
export const routes = [
    ...
    },
    {
        ...
        name: 'MyAssets',
        component: () => {
            return import(/* webpackChunkName: "post-login" */ '@/webapp/views/profile/Assets');
        },
        beforeEnter: (to, from, next) => {
            if (store.getters.isLoggedIn) {
                next();
    ...
    },
    {
        ...
        name: 'PlanDetails',
        component: () => {
            return import(/* webpackChunkName: "post-login" */ '@/webapp/views/plan/Container');
        },
